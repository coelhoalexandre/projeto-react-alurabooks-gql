...
const Livro = () => {
  ...
  const aoAdicionarItemAoCarrinho = () => {
    ...
    if (quantidade <= 0) {
      alert("Por favor, selecione uma quantidade superior a 0!");
    }
    adicionarItemCarrinho({ livro: data.livro, quantidade, opcaoCompra });
  };
          ...
          <div className="detalhes">
            ...
            <footer>
              <div className="qtdContainer">
                <AbInputQuantidade
                  onChange={(quantidade) => setQuantidade(quantidade)}
                  value={quantidade}
                />
              </div>
              <div>
